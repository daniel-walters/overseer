...
import { App, type Dispatcher, type Reviewer, type Rollback, type Killer, type UrlOpener } from "./App.js";
 ...
 */
export function LiveApp({ dispatcher, reviewer, rollback, killer, urlOpener, ...options }: LiveAppProps) {
