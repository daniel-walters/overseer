...
import { App, type Dispatcher, type Reviewer, type Rollback, type Killer, type OpenPr } from "./App.js";
 ...
 */
export function LiveApp({ dispatcher, reviewer, rollback, killer, openPr, ...options }: LiveAppProps) {
