...
import { App, type Dispatcher, type Reviewer, type Rollback, type Killer, type OpenPr, type Delete, type MarkDone, type DetailReader, type UrlOpener } from "./App.js";
 ...
 */
export function LiveApp({ dispatcher, reviewer, rollback, killer, openPr, deleter, markDone, detailReader, urlOpener, reviewCap, ...options }: LiveAppProps) {
